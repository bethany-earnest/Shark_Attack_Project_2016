...
#p <- attack_by_activity %>% filter(freq>5) %>% ggplot(aes(freq,pct_fatal, label = verbs)) + ylab("percent fatal") + #xlab("number of attacks") + ggtitle("Attack Fatalities by Activity") 
